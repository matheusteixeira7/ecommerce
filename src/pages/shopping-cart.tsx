...
export default function ShoppingCart({ data }: Props) {
    function calculateTotal(product: CartInterface) {
                        ...
                        <dl className="mt-6 space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <dd className="text-sm font-medium text-gray-900">{
                                    `$${data.reduce((acc, product) => acc + calculateTotal(product), 0)}`
                                }</dd>
                            </div>
                            ...
                            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                                ...
                                <dd className="text-base font-medium text-gray-900">{`$${data.reduce((acc, product) => acc + (product.price), 0) + 5 + 8.32
                                    }`}</dd>
                            </div>
                        </dl>
